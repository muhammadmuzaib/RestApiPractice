...
public class EmployeeLoginSteps {
    ...
    @Autowired
    public EmployeeLoginSteps(ScenarioContext scenarioContext, EmployeeLoginService employeeLoginService) {
    ...
    public void theEmployeeWithUsernameAndPasswordIsAValid(String username, String password) {
        ...
        boolean isValid = employeeLoginService.isValidEmployee(username, password, correlationId);
